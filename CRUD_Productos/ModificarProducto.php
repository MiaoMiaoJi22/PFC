...
<body>
	...
	$Mostrar = $base->prepare("SELECT * FROM productos WHERE ID = :id");
	$Mostrar->execute(array(":id" => $id_producto));
		...
		<div class="Caja">
			...
			<form action="code.php" method="POST" enctype="multipart/form-data">
				...
				<div class="mb-3">
					...
					<input type="text" name="nombreMod" id="nombre" class="form-control" value="<?php echo $filas['NOMBRE']; ?>" required>
				</div>
				...
				<textarea name="descripcionMod" id="descrip" class="form-control" rows="3"><?php echo $filas['DESCRIPCION']; ?></textarea><br>

				<div class="mb-3">
					<label for="precio" class="form-label">Precio:</label>
					<input type="text" name="precioMod" id="precio" value="<?php echo $filas['PRECIO']; ?>" class="form-control">
					<small>Los precio se pone en este formato: 3.00</small><br>
				</div>

				<div class="mb-3">
					<label for="desc" class="form-label">Descuento:</label>
					<input type="text" name="descMod" id="desc" value="<?php echo $filas['DESCUENTO']; ?>" class="form-control">
				</div>

				<div class="mb-3">
					<label for="tipo" class="form-label">Categorias:</label>
					<select name="selecMod" id="tipo" class="form-select" required>

						<option <?php echo $filas['TIPO']==='Alimentacion' ? "selected='selected'" : "" ?> value="Alimentacion">ALIMENTACION</option>
						<option <?php echo $filas['TIPO']==='Bebida' ? "selected='selected'" : "" ?> value="Bebida">BEBIDA</option>
						<option <?php echo $filas['TIPO']==='Papeleria' ? "selected='selected'" : "" ?> value="Papeleria">PAPELERIA</option>
						<option <?php echo $filas['TIPO']==='Limpieza' ? "selected='selected'" : "" ?> value="Limpieza">LIMPIEZA</option>
						<option <?php echo $filas['TIPO']==='Herramientas' ? "selected='selected'" : "" ?> value="Herramientas">HERRAMIENTAS</option>
						<option <?php echo $filas['TIPO']==='Cosmetico' ? "selected='selected'" : "" ?> value="Cosmetico">COSMÉTICO</option>
						<option <?php echo $filas['TIPO']==='Juego' ? "selected='selected'" : "" ?> value="Juego">JUEGO</option>
				...
				<div class="mb-3">
					...
					<input type="number" name="cantidadMod" id="cant" class="form-control" value="<?php echo $filas['CANTIDAD']; ?>">
				</div>

				<div class="mb-3">
					<label for="image" class="form-label">Imagen:</label>
					<input type="file" name="imageMod" id="image" class="form-control" accept="image/png" value="<?php echo $filas['FOTO']; ?>">
				</div>

				<div class="mb-3">
					<img width="150px" height="150px" src="../<?php echo $filas['FOTO']; ?>">
				</div>

				<div class="centr">
					<input type="submit" class="btn btn-danger" name="btn_cerrar" value="Cerrar">
					<input type="submit" class="btn btn-primary" name="btn_ModificarProducto" value="Modificar">
				</div>
